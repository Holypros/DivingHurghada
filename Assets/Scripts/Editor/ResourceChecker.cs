	...
	void CheckResources()
	{
		...
		foreach (MaterialDetails tMaterialDetails in ActiveMaterials)
		{
			...
			if (tMaterial != null)
			{
				...
				Texture tTexture;
				TextureDetails tTextureDetailobj ;
				foreach (Object obj in dependencies)
				{
					if (obj is Texture)
					{
						tTexture = obj as Texture;
						tTextureDetailobj = GetTextureDetail(tTexture, tMaterial, tMaterialDetails);
						tTextureDetailobj.isSky = tMaterialDetails.isSky;
						tTextureDetailobj.instance = tMaterialDetails.instance;
						tTextureDetailobj.isgui = tMaterialDetails.isgui;
						ActiveTextures.Add(tTextureDetailobj);
					}
				}
